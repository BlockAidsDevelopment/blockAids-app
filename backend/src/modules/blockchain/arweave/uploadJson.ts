...
export const uploadFolder = async () => {
  const data = fs.readFileSync(
    "/Users/tudoriovita/Documents/Projects/blockaids/blockAids-app/backend/src/modules/blockchain/image.png",
  );
  ...
  metadataTransaction.addTag("Entity-Type", "drive");
  metadataTransaction.addTag("Folder", "image");
